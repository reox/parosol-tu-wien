...
class Chebyshev: public Solver
{
  public:
	   ...
	   * @param degree Degree of the solver. This corresponds to the number of iteration.
	   ...
	   * @param maxit The maximum number of iteration to estimate the eigenvalues. (Default 10)
	   * @param lmax Estimation of the biggest eigenvalue. (Default 0 -> means not used)
