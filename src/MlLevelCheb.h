...
public:
   ...
   */
  MlLevelCheb(StiffnessMatrix &M, int approx_it)
      : a(M.GetNrDofs()), b(M.GetNrDofs()),
        solver(M, 200, true, a, b, approx_it, 0, 0, -1) {}
  virtual ~MlLevelCheb() {}
  ...
  const std::string Label() const { return "Chebishev\n"; }
