...
/*! This subroutine computes the element stiffness matrix by numerical
integration (Gauss).
...
void Stiffness_Matrix(const double *mat_prop, const int &nprops, const int &nod,
                      const int &ndof, const int &ndim, const int &nip,
                      const int &nst, const double *coord, double *km);

//! Element stress and strain computation routine.

/*! This subroutine computes the element stress and strain at a given number of
Gauss points.
...
void Element_Stress(const double *mat_prop, const int &nprops, const int &nod,
                    const int &ndof, const int &ndim, const int &nip,
                    const int &nst, const double *coord, double *eld,
                    double *strain, double *stress, double *sigma,
                    double *theta);
