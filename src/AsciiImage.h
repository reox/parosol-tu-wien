 ...
 *  2. n (int) [E (float)]^n n indicates the number of E-moduli. E's E-moduli of the materials. <br>
 *	3. i (int) x*y*z whitespace separated material identifier for each voxel. <br>
 * 
