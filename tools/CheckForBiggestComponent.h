...
// This class deletes all small region that are not connected from the image
...
public:
  ...
  void VisitElement(short x, short y, short z, short component_nr, long &count,
  ...
  void operator()(Image &bone) {
    ...
    int biggest_region =
        max_element(components.begin(), components.end()) - components.begin();
